    ...
    try {
        ...
        if (decodedData) {
            ...
            for (const unlike of unlikes) {
                ...
                const userExistsInLikedBy = await PostModel.exists({
                    _id: postId,
                    [`${imageType}.likedBy`]: decodedData.user._id,
                  });
                ...
                if (userExistsInLikedBy) {
                    ...
                    console.log('you cannot unlike this image because you never liked it')
                }
            }
